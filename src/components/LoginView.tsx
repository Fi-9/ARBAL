 ...
 *
 * LoginView — authentication page for ARBAL.
 *
 * Submits credentials to /api/v1/auth/login via the AuthService.
 * On success the auth store is populated and App.tsx re-renders
 * from login screen to the main dashboard.
 */
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                type="email"
                autoComplete="email"
                placeholder="admin@mustaqbal.sch.id"
                value={email}
